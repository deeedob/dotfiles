...
sys="alacritty clamav plasma-systemmonitor kdeplasma-addons nextcloud-client keepassxc solaar wine wine-gecko wine-mono teams-for-linux flatpak kwin-bismuth unclutter ksshaskpass"
